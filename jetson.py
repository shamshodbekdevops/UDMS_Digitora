...
EYES_WARN_SEC      = 2.0   # Level 2: Ko'z yumiq — mikro-uyqu
EYES_DANGER_SEC     = 5.0   # Level 3: Ko'z yumiq — mutlaq uyqu
HEAD_WARN_SEC       = 2.0   # Level 2: Bosh pastga — mikro-uyqu
HEAD_DANGER_SEC     = 5.0   # Level 3: Bosh pastga — mutlaq uyqu
FACE_GONE_DANGER_SEC = 2.0  # Level 3: Yuz kamerada yo'q (pastga ketgan)
